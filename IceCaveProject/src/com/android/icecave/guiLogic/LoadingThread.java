...
public class LoadingThread extends Thread
{
	...
	public LoadingThread(GUIBoardManager boardManager, Point playerPosition, int wallWidth, GameActivity activity, GameTheme theme)
	{
	...
	public void run()
	{
		...
		mObservable.notifyObservers(Consts.LOADING_LEVEL_FINISHED_UPDATE);
	}
}
