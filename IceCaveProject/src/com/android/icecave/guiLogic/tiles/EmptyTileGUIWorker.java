...
public class EmptyTileGUIWorker implements IGUITileWorker
{
	...
	public TileImageView makeTile(ITile tile, Context context)
	{
		...
		d.setBounds(width * Consts.EMPTY_TILE_IN_SPRITE.x, 
				height * Consts.EMPTY_TILE_IN_SPRITE.y,
				(width * Consts.EMPTY_TILE_IN_SPRITE.x) + width,
				(height * Consts.EMPTY_TILE_IN_SPRITE.y) + height);
