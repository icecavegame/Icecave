...
public class FlagTileGUIWorker implements IGUITileWorker
{
	...
	public TileImageView makeTile(ITile tile, Context context)
	{
		...
		d.setBounds(width * Consts.FLAG_TILE_IN_SPRITE.x, 
				height * Consts.FLAG_TILE_IN_SPRITE.y,
				(width * Consts.FLAG_TILE_IN_SPRITE.x) + width,
				(height * Consts.FLAG_TILE_IN_SPRITE.y) + height);
